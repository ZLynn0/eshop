...
<script type="text/javascript">
 ...
 function go(){
	 ...
	 if(index==0){
	 window.location.href = "${pageContext.request.contextPath }/dispacher.do?type=removesuccess";
	 }
  ...
  <tr>
    <td style="padding:30px; text-align:center"><table width="60%" border="0" cellspacing="0" style="margin-top:70px">
      <tr>
        ...
        <a href="${pageContext.request.contextPath }/dispacher.do?type=removesuccess"><span id="count">5</span>秒后自动为您转跳回购物车界面</a></td>
            <br />
         </td>
      </tr>
    </table>
