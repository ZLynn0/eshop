...
女</td>
  ...
  <tr>
    ...
    <td colspan="2"><input type="text" class="textinput" name="utel"/></td>
  </tr>
  <tr>
...
<table width="80%" border="0" cellspacing="2" class="upline">
  <tr>
    ...
    <td ><img   src="${pageContext.request.contextPath }/codeServlet.do"  id="imgs"></img></td>
  </tr>
  <tr>
    <td style="text-align:right">&nbsp;</td>
    <td>&nbsp;</td>
...
<table width="70%" border="0" cellspacing="0">
  <tr>
    ...
    <input type="image" src="${pageContext.request.contextPath }/images/signup.gif" ></input>
    </td>
  </tr>
</table></td>
    </tr>
